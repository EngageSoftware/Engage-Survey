 ...
 */
if(!Array.prototype.indexOf){Array.prototype.indexOf=function(d){if(this===void 0||this===null){throw new TypeError()}var e=Object(this);var b=e.length>>>0;if(b===0){return -1}var c=0;if(arguments.length>0){c=Number(arguments[1]);if(c!==c){c=0}else{if(c!==0&&c!==(1/0)&&c!==-(1/0)){c=(c>0||-1)*Math.floor(Math.abs(c))}}}if(c>=b){return -1}var a=c>=0?c:Math.max(b-Math.abs(c),0);for(;a<b;a++){if(a in e&&e[a]===d){return a}}return -1}};
(function(a){a(function(){a.validator.addMethod("email",function(D,C){return this.optional(C)||CurrentContextInfo.EmailRegex.test(D)});a.validator.addMethod("emails",function(D,C){return this.optional(C)||CurrentContextInfo.EmailsRegex.test(D)});a.validator.setDefaults({rules:{DefineAnswerType:{min:1},required:{required:true},notificationEmail:{required:{depends:function(C){return a("#EvalSendNotification").is(":checked")}},email:true},notificationEmails:{required:{depends:function(C){return a("#EvalSendNotification").is(":checked")}},emails:true},thankYouEmail:{required:{depends:function(C){return a("#EvalSendThankYou").is(":checked")}},email:true}},messages:CurrentContextInfo.ErrorMessages,onsubmit:false});var B=a("#Form").validate({ignore:"#DefineAnswerType"}),c="normal",r=[],y=$find(a(".ee-start-date .RadPicker input").attr("id")),f=$find(a(".ee-end-date .RadPicker input").attr("id"));window.onbeforeunload=function(){if(a("#CancelQuestion").is(":visible")||a("#EvalCancel").is(":visible")){return CurrentContextInfo.UnsavedChangedWarning}return};a(".ee-collapsed legend a, .ee-expanded legend a").click(function(E){E.preventDefault();var D=a(this).closest(".ee-collapsed, .ee-expanded"),C=D.find(".ee-collapsable");C.slideToggle(c,function(){D.toggleClass("ee-collapsed").toggleClass("ee-expanded")})});a("#ee-previews").sortable({items:"li.ee-preview",placeholder:"ui-state-highlight"});a(".answer-inputs").sortable({items:"li.answer-input",placeholder:"ui-state-highlight"});a("#ee-previews").bind("sortupdate",function(C,F){var E={};a("#ee-previews li.ee-preview:visible").each(function(H,G){E[a(G).data("questionId")]=H+1});var D={surveyId:a(".ee-create-new").data("surveyId"),questionOrderMap:E};d("ReorderQuestions",D)});a(".answer-inputs").bind("sortupdate",function(D,E){var C=a(".answer-inputs li.answer-input:visible").find(".answer-num");C.each(function(G,F){a(F).text(G+1)})});a("#engage-evaluation :input").focus(function(){a(this).addClass("focus")}).blur(function(){a(this).removeClass("focus")});a("#EvalNew").click(function(D){D.preventDefault();if(B.form()){var C=a(this),E=C.text();C.text(CurrentContextInfo.ProgressText);A(function(){a("#EvalNew").parent().fadeOut(c,function(){p()});a(".ee-create-questions").show();C.text(E)})}});a("#EvalUpdate").click(function(D){D.preventDefault();if(B.form()){var C=a(this),E=C.text();C.text(CurrentContextInfo.ProgressText);A(function(){i(function(){p()});C.text(E)})}});function d(D,E,C){jQuery.ajax({type:"POST",url:CurrentContextInfo.WebMethodUrl+D,data:JSON.stringify(E),contentType:"application/json; charset=utf-8",success:function(F){if(a.isFunction(C)){C(F.hasOwnProperty("d")?F.d:F)}},error:function(){alert(CurrentContextInfo.ErrorMessage)}})}function A(C){d("UpdateSurvey",h(),function(D){a(".ee-create-new").data("surveyId",D);if(a.isFunction(C)){C(D)}})}function h(){return{survey:{SurveyId:a(".ee-create-new").data("surveyId")||-1,Text:a("#EvalTitleInput").val(),StartDate:y.get_selectedDate(),PreStartMessage:a("#EvalPreStartTextArea").val(),EndDate:f.get_selectedDate(),PostEndMessage:a("#EvalPostEndTextArea").val(),SendNotification:a("#EvalSendNotification").is(":checked"),NotificationFromEmailAddress:a("#EvalNotificationFromEmail").val(),NotificationToEmailAddresses:a("#EvalNotificationToEmails").val(),SendThankYou:a("#EvalSendThankYou").is(":checked"),ThankYouFromEmailAddress:a("#EvalThankYouFromEmail").val(),PortalId:CurrentContextInfo.PortalId,ModuleId:CurrentContextInfo.ModuleId,RevisingUser:CurrentContextInfo.UserId,Sections:[{Text:a("#EvalDescTextArea").val()}]}}}a("#EvalEdit").click(function(C){C.preventDefault();z(a("#EvalTitleInput"));z(a("#EvalDescTextArea"));z(a(".ee-start-date .RadPicker"),y.get_selectedDate());z(a("#EvalPreStartTextArea"));z(a(".ee-end-date .RadPicker"),f.get_selectedDate());z(a("#EvalPostEndTextArea"));z(a("#EvalSendNotification"),a("#EvalSendNotification").is(":checked"));z(a("#EvalNotificationFromEmail"));z(a("#EvalNotificationToEmails"));z(a("#EvalSendThankYou"),a("#EvalSendThankYou").is(":checked"));z(a("#EvalThankYouFromEmail"));n(a("#EvalTitleInput"),a('<input type="text"/>'));n(a("#EvalDescTextArea"),a("<textarea/>"));k(y);n(a("#EvalPreStartTextArea"),a("<textarea/>"));k(f);n(a("#EvalPostEndTextArea"),a("<textarea/>"));n(a("#EvalSendNotification"),a('<input type="checkbox"/>'));n(a("#EvalNotificationFromEmail"),a('<input type="text"/>'));n(a("#EvalNotificationToEmails"),a('<input type="text"/>'));n(a("#EvalSendThankYou"),a('<input type="checkbox"/>'));n(a("#EvalThankYouFromEmail"),a('<input type="text"/>'));a(".ee-create-new .ee-optional").show();a("#EvalEdit").parent().fadeOut(c,function(){a("#EvalCancel").parent().fadeIn(c);a("#EvalUpdate").parent().fadeIn(c)});B=a("#Form").validate()});a("#EvalCancel").click(function(C){C.preventDefault();w(a("#EvalTitleInput"));w(a("#EvalDescTextArea"));v(y);w(a("#EvalPreStartTextArea"));v(f);w(a("#EvalPostEndTextArea"));t(a("#EvalSendNotification"));w(a("#EvalNotificationFromEmail"));w(a("#EvalNotificationToEmails"));t(a("#EvalSendThankYou"));w(a("#EvalThankYouFromEmail"));i(function(){p()});B.resetForm()});a("#EvalDelete").click(function(D){D.preventDefault();e(a("#engage-evaluation"),true,null,function C(){d("DeleteSurvey",{surveyId:a(".ee-create-new").data("surveyId")},function(){window.location=a(".egn-home a").attr("href")})})});function z(C,D){C.parent().data("previousValue",D===undefined?C.text():D)}function w(C){C.val(C.parent().data("previousValue"))}function t(C){C.attr("checked",C.parent().data("previousValue"))}function v(C){C.set_selectedDate(a(C.get_element()).closest(".RadPicker").parent().data("previousValue"))}function p(){var D,C;m(a("#EvalTitleInput"));o(a("#EvalDescTextArea"),a(".ee-description"));C=o(y,a(".ee-start-date"),y.get_selectedDate(),l);D=C;C=o(a("#EvalPreStartTextArea"),a(".ee-pre-start"));D=D||C;C=o(f,a(".ee-end-date"),f.get_selectedDate(),l);D=D||C;C=o(a("#EvalPostEndTextArea"),a(".ee-post-end"));D=D||C;a(".ee-timeframe.ee-expanded legend a").click();if(!D){a(".ee-timeframe").slideUp(c)}o(a("#EvalSendNotification"),a(".ee-notification"),a("#EvalSendNotification").is(":checked")?CurrentContextInfo.CheckBoxCheckedText:CurrentContextInfo.CheckBoxUncheckedText);o(a("#EvalNotificationFromEmail"),a(".ee-notification-from"));o(a("#EvalNotificationToEmails"),a(".ee-notification-to"));o(a("#EvalSendThankYou"),a(".ee-thankyou"),a("#EvalSendThankYou").is(":checked")?CurrentContextInfo.CheckBoxCheckedText:CurrentContextInfo.CheckBoxUncheckedText);o(a("#EvalThankYouFromEmail"),a(".ee-thankyou-from"));a(".ee-email.ee-expanded legend a").click();a("#EvalEdit").parent().fadeIn(c);a("#EvalDelete").parent().fadeIn(c)}function o(C,D,F,E){F=(F===undefined&&a.isFunction(C.val))?C.val():F;if(F){E=E||m;E(C,F);D.slideDown(c);return true}else{D.slideUp(c,function(){a(this).hide()})}}function m(C,D){C.slideUp(c,function(){var F=a(this),G=F.attr("maxlength"),E;if(G<0||G>500000){G=""}E=a("<span />").attr({id:F.attr("id"),className:F.attr("class"),name:F.attr("name")}).data("minlength",F.attr("minlength")||"").data("maxlength",G||"").data("rows",F.attr("rows")||"").data("cols",F.attr("cols")||"").data("checked",F.attr("checked")!==undefined?F.is(":checked"):"").addClass("ee-input-pre").text(D||F.val()).hide().insertAfter(F).fadeIn(c);F.remove();E.html(E.html().replace(/\n/g,"\n<br />"))}).addClass("ee-input-pre")}function n(C,D){C.fadeOut(c,function(){var E=a(this),F=E.data("maxlength");D.attr({id:E.attr("id"),className:E.attr("class"),name:E.attr("name"),minlength:E.data("minlength"),rows:E.data("rows"),cols:E.data("cols"),checked:E.data("checked")}).val(E.text()).hide().insertAfter(E).slideDown(c);if(F!==""){D.attr("maxlength",F)}E.remove()}).removeClass("ee-input-pre")}function l(F){var E=a(F.get_element()).closest(".ee-input"),D=E.find(".RadPicker"),C=E.find(".ee-date-pre");if(C.length===0){C=a("<span />").addClass("ee-date-pre").insertAfter(D)}D.slideUp(c,function(){var G=F.get_dateInput();C.text(G.get_dateFormatInfo().FormatDate(F.get_selectedDate(),G.get_displayDateFormat())).hide().fadeIn(c);D.hide()})}function k(F){var E=a(F.get_element()).closest(".ee-input"),D=E.find(".RadPicker"),C=E.find(".ee-date-pre");C.slideUp(c,function(){D.fadeIn(c)})}function i(C){a("#EvalUpdate").parent().fadeOut(c);a("#EvalCancel").parent().fadeOut(c,C)}a("#AddNewQuestion").click(function(F){F.preventDefault();var D=a(".answer-input:visible:last .answer-num");var C=a(".answer-input-template").clone(true).attr("class","answer-input").hide().appendTo(".answer-inputs").slideDown(c);var E=parseInt(D.text(),10);C.find(".answer-num").text(E+1);C.find("input").val("").focus();a(".answer-inputs .ee-delete").removeClass("disabled")});a(".answer-inputs .ee-delete").click(function(G){G.preventDefault();var C=a(".answer-inputs li.answer-input:visible");if(C.length>1){var D=a(this).closest("li");e(D,false,function E(){C=a(".answer-inputs li.answer-input:visible").each(function(I,H){a(H).find(".answer-num").text(I+1)});if(C.length<2){C.find(".ee-delete").addClass("disabled")}},null,function F(){a(".answer-inputs li.answer-input:visible").each(function(I,H){a(H).find(".answer-num").text(I+1)}).find(".ee-delete").removeClass("disabled")})}});a(".ee-pr-action-links .ee-edit").click(function(D){D.preventDefault();var C=a(this).closest("li.ee-preview");s(C,true);a("#SaveQuestion").text(CurrentContextInfo.UpdateQuestionButtonText).attr("title",CurrentContextInfo.UpdateQuestionToolTip)});a(".ee-pr-action-links .ee-copy").click(function(D){D.preventDefault();var C=a(this).closest("li.ee-preview");s(C,false);a("#SaveQuestion").text(CurrentContextInfo.SaveQuestionButtonText).attr("title",CurrentContextInfo.SaveQuestionToolTip)});a(".ee-pr-action-links .ee-delete").click(function(E){E.preventDefault();var C=a(this).closest("li.ee-preview");e(C,true,null,function D(){var F=C.data("questionId");d("DeleteQuestion",{questionId:F},function(){C.remove()})})});function e(C,G,D,F,E){C.fadeOut("slow",function(){var J,H=C.siblings(".ee-undo").eq(0).clone().show().removeClass("template"),L=H.html(),M=11,K=new Date(),I;if(a.isFunction(D)){D()}H.html(L.replace("{0}",'<span class="undo-limit"></span>'));C.addClass("deleted");C.before(H);H.hide().fadeIn(c);if(G){I=function(){H.remove();r.splice(r.indexOf(I),1);if(a.isFunction(F)){F()}};r.push(I);J=setTimeout(I,M*1000);(function N(){var O=new Date(),P=O.getTime()-K.getTime(),Q=(M*1000)-P,R=parseInt(Q/1000,10);H.find("span.undo-limit").text(R.toString(10));if(R>0){setTimeout(N,300)}}())}H.find("a").click(function(O){O.preventDefault();clearTimeout(J);r.splice(r.indexOf(I),1);H.fadeOut(c,function(){C.removeClass("deleted").fadeIn(c);H.remove()});if(a.isFunction(E)){E()}})})}a(window).unload(function(){a.each(r,function(D,C){if(a.isFunction(C)){C()}})});function s(D,G){u();var F=D.data("questionType");var E=D.data("questionId");a("#QuestionText").val(D.children(".pv-question").text());a("#QuestionRequiredCheckBox").attr("checked",D.children(".ee-required-label").text()==="*");if(G){a("#CreateQuestions").data("questionId",E).data("relativeOrder",a("#ee-previews li.ee-preview").index(D)+1)}a("#DefineAnswerType").val(F);x(F);if(F!=2&&F!=1&&F!=0){a("#CancelQuestion").parent().show();var C=a(".answer-inputs li.answer-input:last").clone(true);a(".answer-inputs li.answer-input").remove();D.find(".pv-answer").find("input, option").each(function(J){var H=C.clone(true);var I=H.find(".answer-num").text(J+1);H.find("input").val(a(this).text()||a(this).parent().text());H.appendTo(".answer-inputs");if(G){H.data("answerId",a(this).data("answerId"))}})}}a("#DefineAnswerType").change(function(C){x(parseInt(a(this).val(),10))});a("#QuestionText").blur(function(C){x(parseInt(a("#DefineAnswerType").val(),10))});function x(I){var F=a("#MultipleAnswer"),H=a("#ShortTextAnswer"),E=a("#LongTextAnswer"),C=a(".ee-define-answer .primary-btn"),G=a("#SaveQuestion").parent(),D=a("#CancelQuestion").parent();G.removeClass("disabled");if(a("#QuestionText").val()||a("#DefineAnswerType :selected").val()>0){D.fadeIn(c)}else{D.fadeOut(c)}switch(I){case 0:E.slideUp(c);H.slideUp(c);F.slideUp(c);C.slideUp(c);G.addClass("disabled");break;case 2:F.slideUp(c);E.slideUp(c);C.fadeOut(c,function(){H.slideDown(c)});break;case 1:H.slideUp(c);F.slideUp(c);C.fadeOut(c,function(){E.slideDown(c)});break;default:E.slideUp(c);H.slideUp(c,function(){F.slideDown(c);C.fadeIn(c)})}}a("#SaveQuestion").click(function(C){C.preventDefault();var E=a("#DefineAnswerType :selected").val(),D=E>2;B=a("#Form").validate();if(a("#QuestionText").valid()&&(!D||a(".ai-input input:visible").valid())&&(a("#DefineAnswerType").valid())){a(this).text(CurrentContextInfo.ProgressText).parent().addClass("disabled");d("UpdateQuestion",g(),function(F){a("#PreviewArea").slideDown(c);b(F.QuestionId,a("#QuestionText").val(),a("#QuestionRequiredCheckBox").is(":checked"),parseInt(a("#DefineAnswerType :selected").val(),10),F.Answers);u()})}});a("#CancelQuestion").click(function(C){C.preventDefault();u()});function b(H,J,G,K,F){var E,I=a("#CreateQuestions").data("relativeOrder");if(I){E=a(".ee-preview").eq(I-1)}else{E=a(".ee-preview-template").clone(true).attr("class","ee-preview");a("#ee-previews").append(E)}E.find(".pv-question").text(J).show();E.find(".ee-required-label").text(G?"*":"").show();E.show().data("questionId",H).data("questionType",K);var C=E.find(".pv-answer").empty();switch(K){case 2:C.html("<input type='text' class='NormalTextBox' />");break;case 1:C.html("<textarea class='NormalTextBox' />");break;case 5:var D=a("<select class='NormalTextBox dropdown-prev'></select>");C.append(D);a.each(F,function(M,L){a("<option>"+L.Text+"</option>").appendTo(D).data("answerId",L.AnswerId)});break;case 3:a.each(F,function(M,L){a("<label><input type='radio' name='"+H+"' />"+L.Text+"</label>").appendTo(C).find("input").data("answerId",L.AnswerId)});break;case 6:a.each(F,function(M,L){a("<label><input type='checkbox' />"+L.Text+"</label>").appendTo(C).find("input").data("answerId",L.AnswerId)});break;default:alert("todo: implement validation, shouldn't be able to add a question if you have 'select answer type' selected in the drop down.")}}function u(){a("#QuestionText").val("");a("#QuestionRequiredCheckBox").attr("checked",true);a("#DefineAnswerType").find("option:first").attr("selected",true);a("#ShortTextAnswer").slideUp(c);a("#LongTextAnswer").slideUp(c);a("#MultipleAnswer").slideUp(c);a("#CancelQuestion").parent().fadeOut(c);a("#AddNewQuestion").parent().fadeOut(c);a("#MultipleAnswer li.answer-input.deleted").add(".answer-inputs li.ee-undo:not(.template)").remove();a("#MultipleAnswer li.answer-input").remove();var C=a("#MultipleAnswer li.answer-input-template");C.clone(true).attr("class","answer-input").show().insertAfter(C).find(".answer-num").text(2);C.clone(true).attr("class","answer-input").show().insertAfter(C).find(".answer-num").text(1);a(".ai-input input").val("");a("#SaveQuestion").text(CurrentContextInfo.SaveQuestionButtonText).attr("title",CurrentContextInfo.SaveQuestionToolTip).parent().addClass("disabled");a("#CreateQuestions").removeData("questionId").removeData("relativeOrder").find("#MultipleAnswer li.answer-input").removeData("answerId");B.resetForm()}function g(){return{surveyId:a(".ee-create-new").data("surveyId")||-1,question:{QuestionId:a("#CreateQuestions").data("questionId")||-1,Text:a("#QuestionText").val(),IsRequired:a("#QuestionRequiredCheckBox").is(":checked"),RelativeOrder:a("#CreateQuestions").data("relativeOrder")||a(".ee-preview").length+1,ControlType:a("#DefineAnswerType").val(),RevisingUser:CurrentContextInfo.UserId,Answers:a.map(a("#MultipleAnswer:visible .answer-inputs li.answer-input:visible"),function(D,E){var C=a(D);return{AnswerId:C.data("answerId")||-1,Text:C.find(":input").val()}})}}}function q(C){if(C){return new Date(parseInt(C.replace("/Date(","").replace(")/",""),10))}return null}(function j(){if(y===null||f===null){setTimeout(function(){y=$find(a(".ee-start-date .RadPicker input").attr("id")),f=$find(a(".ee-end-date .RadPicker input").attr("id"));j()},1);return}if(CurrentContextInfo.Survey){a(".ee-create-new").data("surveyId",CurrentContextInfo.Survey.SurveyId);a("#EvalTitleInput").val(CurrentContextInfo.Survey.Text);a("#EvalDescTextArea").val(CurrentContextInfo.Survey.Sections[0].Text);y.set_selectedDate(q(CurrentContextInfo.Survey.StartDate));a("#EvalPreStartTextArea").val(CurrentContextInfo.Survey.PreStartMessage);f.set_selectedDate(q(CurrentContextInfo.Survey.EndDate));a("#EvalPostEndTextArea").val(CurrentContextInfo.Survey.PostEndMessage);a("#EvalSendNotification").attr("checked",CurrentContextInfo.Survey.SendNotification);a("#EvalNotificationFromEmail").val(CurrentContextInfo.Survey.NotificationFromEmailAddress);a("#EvalNotificationToEmails").val(CurrentContextInfo.Survey.NotificationToEmailAddresses);a("#EvalSendThankYou").attr("checked",CurrentContextInfo.Survey.SendThankYou);a("#EvalThankYouFromEmail").val(CurrentContextInfo.Survey.ThankYouFromEmailAddress);a("#EvalNew").parent().hide();p();i();a(".ee-create-questions").show();if(CurrentContextInfo.Survey.Sections[0].Questions.length){a("#PreviewArea").show();a.each(CurrentContextInfo.Survey.Sections[0].Questions,function(C,D){b(D.QuestionId,D.Text,D.IsRequired,D.ControlType,D.Answers)})}}else{a("#EvalSendNotification").attr("checked",CurrentContextInfo.DefaultEmailSettings.SendNotification);a("#EvalNotificationFromEmail").val(CurrentContextInfo.DefaultEmailSettings.NotificationFromEmail);a("#EvalNotificationToEmails").val(CurrentContextInfo.DefaultEmailSettings.NotificationToEmails);a("#EvalSendThankYou").attr("checked",CurrentContextInfo.DefaultEmailSettings.SendThankYou);a("#EvalThankYouFromEmail").val(CurrentContextInfo.DefaultEmailSettings.ThankYouFromEmail)}u()}())})})(jQuery);
